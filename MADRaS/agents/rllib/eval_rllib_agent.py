...
CHECKPOINT = "/home/saivinay/ray_results/PPO_madras_env_2020-05-20_12-48-02ghj0ji1k/checkpoint_121/checkpoint-121"
EVAL = "home/saivinay/Documents/RL_project/MADRaS/MADRaS/agents/rllib/evaluation"
...
def log_results_single_agent_no_traffic():
    ...
    ==================================================
    """
    OUTFILE = open("/home/saivinay/Documents/RL_project/MADRaS/MADRaS/agents/rllib/evaluation/temp/results.txt", 'a')
    OUTFILE.write("Evaluating {} on {} in {}\n\n".format(CHECKPOINT, CARS, TRACKS))
    SIM_OPTIONS_PATH = "/home/saivinay/Documents/RL_project/MADRaS/MADRaS/envs/data/madras_config.yml"
    ...
    for track in TRACKS:
        for car in CARS:
              ...
              data_path = "/home/saivinay/Documents/RL_project/MADRaS/MADRaS/agents/rllib/evaluation/temp/eval_trajs_{}_{}.pkl".format(car, track)
              os.system("rllib rollout {} --env Madras-v0 --steps 10000 --run PPO --no-render --out {}".format(CHECKPOINT, data_path))
              os.system("pkill torcs")
              exit()
              print(f"--------- {track} {car} combination done -------")
